...
if [[ -n $4 ]]; then
    ...
    ports=(22 2181 3372 3373 6627 6700 6701 6702 6703 8010 8020 8025 8030 8032 8050 8080 8081 8088 8141 8744 9000 9080 9081 9082 9083 9084 9085 9086 9087 9999 9933 10000 10020 11000 19888 45454 50010 50020 50060 50070 50075 50090 50111)
    for i in ${ports[@]}; do
